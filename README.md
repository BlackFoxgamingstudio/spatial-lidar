...
[![CI](https://github.com/BlackFoxgamingstudio/spatial-lidar/actions/workflows/ci.yml/badge.svg)](https://github.com/BlackFoxgamingstudio/spatial-lidar/actions/workflows/ci.yml)
...
| **REST Gateway** | ✅ Live on Port `8803` | `POST /api/v1/execute`, `GET /health` |
