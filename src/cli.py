#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-spatial-lidar
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="iOS Apple RoomPlan and LiDAR spatial mesh reconstruction toolkit. Ingests raw USDZ 3D room scans (`RoomScan_*.usdz`) and object scans, extracts parametric bounding boxes, and exports digital twin coordinates to SQLite/JSON.")
